      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            DhikrCard(
              text:
                  'مَا مِنْ عَبْدٍ يَقُولُ في صَبَاحِ كلِّ يَوْمٍ ومَسَاءٍ كلِّ لَيْلَةٍ : بِسْمِ اللَّهِ الَّذِي لاَ يَضُرُّ مَع اسْمِهِ شيء في الأرضِ ولا في السماءِ وَهُوَ السَّمِيعُ الْعلِيمُ ، ثلاثَ مَرَّاتٍ ، إِلاَّ لَمْ يَضُرَّهُ شَيءٌ',
              category: 'أذكار الصباح',
              fontSize: 28,
            ...
            DhikrCard(
              text:
                  'اللَّهُمَّ عِافِنِي في بصَري, لا إلهَ إلا أنتَ. اللَّهُمَّ إنّي أعُوذُ بِكَ مِنَ الكُفْرِ, وَ الفَقْرِ, اللَّهُمَّ إنِّي أعُوذُ بِكَ مِنْ عَذَابِ القَبْرِ, لا إلهَ إلا أَنْتَ',
              category: 'أذكار الصباح',
              source: 'ثَلاثاً حِينَ تُصْبحُ, وثَلاثاً حِينَ تُمسِي',
              fontSize: 28,
            ...
            DhikrCard(
              text:
                  'سَيِّدُ الاستغفار: اللهـمَّ أَنتَ ربِّي, لا إلهَ إلا أنتَ, خَلَقْتَني, وأَنا عبدُكَ, وأَنا على عهدِكَ ووعدِكَ, ما استَطَعْتُ, أعـوذُ بـكَ مِن شرِّ ما صَنَعْتُ, أبوءُ لكَ بنِعْمَتِكَ عليِّ, وأَبوءُ لَكَ بذَنبي, فاغفِرْ لي, فإنَّه لا يَغفِرُ الذُّنوبَ إلا أَنتَ',
              category: 'أذكار الصباح',
              source:
                  'مَن قالَها مِنَ النَّهارِ مُوقِناً بِهَا, فَماتَ مِنْ يَوْمِه قَبْلَ أَنْ يُمْسي, فَهو مِنْ أَهْلِ الجنَّة',
              fontSize: 28,
