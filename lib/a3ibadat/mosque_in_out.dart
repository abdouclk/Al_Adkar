...
class MosqueInOut extends StatelessWidget {
  MosqueInOut({Key? key}) : super(key: key);
    ...
    return AppScaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            DhikrCard(
              text: 'عند الدخول: اللَّهُمَّ افْتَحْ لِي أَبْوَابَ رَحْمَتِكَ',
              category: 'دعاء دخول وخروج المسجد',
              fontSize: 24,
