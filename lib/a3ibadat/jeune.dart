...
class Jeune extends StatelessWidget {
  Jeune({Key? key}) : super(key: key);
    ...
    return AppScaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            DhikrCard(
              text: 'عند السحور: اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنْ فَضْلِكَ',
              category: 'أذكار الصيام',
              fontSize: 24,
            ...
            DhikrCard(
              text:
                  'عند الإفطار: ذَهَبَ الظَّمَأُ وَابْتَلَّتِ الْعُرُوقُ وَثَبَتَ الأَجْرُ إِنْ شَاءَ اللَّهُ',
              category: 'أذكار الصيام',
              fontSize: 24,
