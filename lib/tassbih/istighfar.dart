...
class Istighfar extends StatefulWidget {
  Istighfar({Key? key}) : super(key: key);

  @override
  State<Istighfar> createState() => _IstighfarState();
}

class _IstighfarState extends State<Istighfar> {
  int _counter = 0;
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              _buildTextWidget(
                'أَسْتَغْفِرُ اللَّهَ العَظِيمَ الَّذِي لاَ إِلَهَ إِلاَّ هُوَ الحَيَّ القَيُّومَ وَأَتُوبُ إِلَيْهِ',
                fontSize: 24,
              ...
              SizedBox(height: 32),
              _buildTextWidget(
                'من قالها وإن كان فر من الزحف غُفِرَ له',
                fontSize: 20,
              ...
              SizedBox(height: 20),
              _buildTextWidget(
                'أَسْتَغْفِرُ اللَّهَ وَأَتُوبُ إِلَيْهِ (يُستحب تكرارها)',
                fontSize: 26,
