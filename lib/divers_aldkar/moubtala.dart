...
class Moubtala extends StatelessWidget {
  Moubtala({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            DhikrCard(
              text:
                  'الحَمْدُ للَّهِ الَّذِي عَافَانِي مِمَّا ابْتَلاَكَ بِهِ، وَفَضَّلَنِي عَلَى كَثِيرٍ مِمَّنْ خَلَقَ تَفْضِيلاً'
                  '\n-----------------------------\n'
                  'يقال هذا سراً حتى لا يسمعه المبتلى',
              category: 'دعاء المبتلى',
              fontSize: 24,
